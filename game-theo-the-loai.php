...
$sobanghi = Game::demSoBanGhiTheoTheLoai($pdo, $genreid)->sobanghi;
$minpage = 1;
...
//co phan trang
$data = Game::timGameTheoTheLoai($pdo, $limit, $offset, $genreid);
...
<div class="background-image min-vh-100">
    <div class="container pt-3"> <!--bao nguyên thân tất cả game-->
        <?php $namegenre = Game::getTenTheLoai($pdo, $genreid)?>
        <h2 style="font-weight: bold; color: white">DANH SÁCH GAME THỂ LOẠI: <?=$namegenre->name?></h2>
            ...
            <?php foreach($data as $game): ?>
                <div class="col-12 col-md-6 col-lg-4" style="margin-top: 25px;">
                    ...
                    <a href="game.php?id=<?=$game->id ?>"><div class="card-body box">
                            ...
                            <!-- name -->
                            <h5 class="card-title"><a style="color:black; text-decoration-line: none; font-weight: bold;" href="gamedetail.php?id=<?=$game->id ?>"><?= $game->name ?></a></h5>
                            <!-- genre -->
                            <di class="card-title">
        ...
        <?php else: ?>
            <h2 style="color:white; text-align: center; font-weight: bold;">KHÔNG CÓ NỘI DUNG NÀO ĐƯỢC TÌM THẤY!</h2> 
        <?php endif; ?>
    </div>
